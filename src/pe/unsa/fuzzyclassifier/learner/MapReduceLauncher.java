package pe.unsa.fuzzyclassifier.learner;
...
import pe.unsa.fuzzyclassifier.core.NominalVariable;
import pe.unsa.fuzzyclassifier.core.Variable;
import pe.unsa.fuzzyclassifier.learner.stage1.Stage1;
import pe.unsa.fuzzyclassifier.learner.stage2.Stage2;
import pe.unsa.fuzzyclassifier.learner.stage3.Stage3;
import pe.unsa.fuzzyclassifier.utils.ByteArrayWritable;
import pe.unsa.fuzzyclassifier.utils.FrequentSubsetWritable;

/**
 * Inicia las dos etapas de MapReduce que generan la base de reglas (salida de MapReduce) y la base de datos.
 * Uso: hadoop jar <jar_file> pe.unsa.fuzzyclassifier.learner.mapreduce.MapReduceLauncher [-p] [-v] <hdfs://url:port> <parameters_file> <header_file> <input_path> <output_path>
 *
 * @version 1.0
 */
public class MapReduceLauncher {
    ...
    private static final String COMMAND_STR = "hadoop jar <jar_file> pe.unsa.fuzzyclassifier.learner.mapreduce.MapReduceLauncher"+printOptionalArgs()+"<hdfs://url:port> <parameters_file> <header_file> <input_path> <output_path>";
