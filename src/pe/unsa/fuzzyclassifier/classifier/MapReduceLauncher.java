...
/**
 * Inicia MapReduce para clasificar ejemplos de entrada.
 * Uso: hadoop jar <jar_file> pe.unsa.fuzzyclassifier.classifier.mapreduce.MapReduceLauncher [-p] [-v] <hdfs://url:port> <parameters_file> <header_file> <input_database_path> <input_rulebase_path> <input_path> <output_path>
 *
 * @version 1.0
 */
public class MapReduceLauncher {
    ...
    private static final String COMMAND_STR = "hadoop jar <jar_file> pe.unsa.fuzzyclassifier.classifier.MapReduceLauncher"+printOptionalArgs()+"<hdfs://url:port> <parameters_file> <header_file> <input_database_path> <input_rulebase_path> <input_path> <output_path>";
