...
public class Mediator {
     ...
     */
    public static void readClassifierConfiguration () throws Exception, IOException, ClassNotFoundException{
     ...
     * @throws ClassNotFoundException 
     */
    private static void readClassNumExamples () throws Exception, IOException, ClassNotFoundException {
    	
    	byte[] bytes = Base64.getDecoder().decode(configuration.get(CLASS_NUM_EXAMPLES_FIELD).getBytes());
     ...
     * @throws ClassNotFoundException 
     */
    public static void readHadoopConfiguration () throws Exception, IOException, ClassNotFoundException{
     ...
     * @throws ClassNotFoundException 
     */
    public static void readLearnerConfiguration () throws Exception, IOException, ClassNotFoundException{
    	...
    	// Read class labels
    	byte[] bytes = Base64.getDecoder().decode(configuration.get(CLASS_LABELS_FIELD).getBytes());
    	ObjectInputStream objectInputStream = new ObjectInputStream(new ByteArrayInputStream(bytes));
    	classLabels = (String[])objectInputStream.readObject();
    	
    	// Read variables
    	bytes = Base64.getDecoder().decode(configuration.get(VARIABLES_FIELD).getBytes());
    ...
    private static void saveClassLabels (String[] newClassLabels) throws IOException {
	    ...
	    String classLabelsStr = new String(Base64.getEncoder().encode(byteArrayOutputStream.toByteArray()));
    ...
    private static void saveClassNumExamples (ArrayList<Long> numExamplesByClass) throws IOException {
	    ...
	    objectOutputStream.close();
	    String outputString = new String(Base64.getEncoder().encode(byteArrayOutputStream.toByteArray()));
    ...
    private static void saveVariables (Variable[] newVariables) throws IOException {
	    ...
	    objectOutputStream.close();
	    String variablesStr = new String(Base64.getEncoder().encode(byteArrayOutputStream.toByteArray()));
